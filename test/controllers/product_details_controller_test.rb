...
class ProductDetailsControllerTest < ActionController::TestCase
  ...
  test "should create product_detail" do
    assert_difference('ProductDetail.count') do
      post :create, product_detail: { model_id: @product_detail.model_id, price: @product_detail.price, product_id: @product_detail.product_id, shoping_card_id: @product_detail.shoping_card_id }
    end
  ...
  test "should update product_detail" do
    patch :update, id: @product_detail, product_detail: { model_id: @product_detail.model_id, price: @product_detail.price, product_id: @product_detail.product_id, shoping_card_id: @product_detail.shoping_card_id }
    assert_redirected_to product_detail_path(assigns(:product_detail))
  end
