class AccessoriesController < ApplicationController
  ...
  def index
    @accessories = Accessory.availabe.search_by(params[:search])
  end
  ...
  private
    ...
    def accessory_params
      params.require(:accessory).permit(:serial_number, :name, :image, :modal_id, :data, :price, :description, :bought_date, :sold_date)
    end
end
